...
app.get("/api/workexperience", (req, res) => {
    ...
    client.query(`SELECT id, companyname, jobtitle, location, TO_CHAR(startdate, 'YYYY-MM-DD') AS startdate, enddate, description FROM workexperience ORDER BY startdate ASC;`, (err, results) => {
        if (err) {
